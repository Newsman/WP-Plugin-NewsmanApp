	...
	<h2>Newsman Templates</h2>
		<table class="form-table">
			...
			<tr>
				...
				<td>
					<textarea name="newsman_template_edit" class="newsman-template-editor" cols="30" rows="10" autocomplete="off"></textarea>
			...
			<tr>
				...
				<td>
					<button id="newsman-templates-editor-save" type="button" class="button button-primary">Save changes</button>
