				...
				<form method="post" enctype="multipart/form-data" id="mainForm">
					...
					<table class="form-table newsman-table">
						...
						<tr>
							...
							<td>
								<input name="newsman_usesms" type="checkbox" id="newsman_usesms" <?php echo ( 'on' === $this->form_values['newsman_usesms'] ) ? 'checked' : ''; ?>/>
							</td>
						</tr>
						<tr>
							<th scope="row">
						...
						<tr>
							...
							<td class="newsman_smspendingtextPanel" <?php echo ( empty( $this->form_values['newsman_smspendingactivate'] ) || 'off' === $this->form_values['newsman_smspendingactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smspendingtext">Message</label>
								<textarea id="newsman_smspendingtext" name="newsman_smspendingtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smspendingtext'] ) ) ? esc_html( $this->form_values['newsman_smspendingtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smsfailedtextPanel" <?php echo ( empty( $this->form_values['newsman_smsfailedactivate'] ) || 'off' === $this->form_values['newsman_smsfailedactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smsfailedtext">Message</label>
								<textarea id="newsman_smsfailedtext" name="newsman_smsfailedtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smsfailedtext'] ) ) ? esc_html( $this->form_values['newsman_smsfailedtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smsonholdtextPanel" <?php echo ( empty( $this->form_values['newsman_smsonholdactivate'] ) || 'off' === $this->form_values['newsman_smsonholdactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smsonholdtext">Message</label>
								<textarea id="newsman_smsonholdtext" name="newsman_smsonholdtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smsonholdtext'] ) ) ? esc_html( $this->form_values['newsman_smsonholdtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smsprocessingtextPanel" <?php echo ( empty( $this->form_values['newsman_smsprocessingactivate'] ) || 'off' === $this->form_values['newsman_smsprocessingactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smsprocessingtext">Message</label>
								<textarea id="newsman_smsprocessingtext" name="newsman_smsprocessingtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smsprocessingtext'] ) ) ? esc_html( $this->form_values['newsman_smsprocessingtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smscompletedtextPanel" <?php echo ( empty( $this->form_values['newsman_smscompletedactivate'] ) || 'off' === $this->form_values['newsman_smscompletedactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smscompletedtext">Message</label>
								<textarea id="newsman_smscompletedtext" name="newsman_smscompletedtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smscompletedtext'] ) ) ? esc_html( $this->form_values['newsman_smscompletedtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smsrefundedtextPanel" <?php echo ( empty( $this->form_values['newsman_smsrefundedactivate'] ) || 'off' === $this->form_values['newsman_smsrefundedactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smsrefundedtext">Message</label>
								<textarea id="newsman_smsrefundedtext" name="newsman_smsrefundedtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smsrefundedtext'] ) ) ? esc_html( $this->form_values['newsman_smsrefundedtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
						...
						<tr>
							...
							<td class="newsman_smscancelledtextPanel" <?php echo ( empty( $this->form_values['newsman_smscancelledactivate'] ) || 'off' === $this->form_values['newsman_smscancelledactivate'] ) ? 'style="display: none;"' : ''; ?>>
								<label style="display: none;" for="newsman_smscancelledtext">Message</label>
								<textarea id="newsman_smscancelledtext" name="newsman_smscancelledtext" style="width: 100%; min-height: 100px;"><?php echo ( ! empty( $this->form_values['newsman_smscancelledtext'] ) ) ? esc_html( $this->form_values['newsman_smscancelledtext'] ) : 'Order no. {{order_number}}, in total of {{order_total}} EURO, from example.com'; ?></textarea>
					...
					<tr>
						...
						<td>
							<input id="newsman_smstestnr" name="newsman_smstestnr" value="<?php echo esc_attr( $this->form_values['newsman_smstestnr'] ); ?>" /> Ex: 0720998111
						</td>
					</tr>
					</table>
					<h2>SMS send test</h2>
