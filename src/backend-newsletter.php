...
<div class="wrap">
		...
		<div id="nws-message" class="<?php echo $this->message['status']?>"><p><strong><?php _e( $this->message['message'] ); ?></strong></p></div>
		...
		<tbody>
				...
				<tr>
					<th scope="row">
						...
						<p class="description">To change the order in which the posts are placed in the newsletter. Click on a post and drag it in the desired position.</p>
					</th>
					<td>
				...
				<tr>
					<th scope="row">
						<input type="submit" value="Preview" class="button button-primary" id="newsman-preview-newsletter" data-target="#myModal"/>
						<button type="button" data-dismiss="modal" class="button button-primary newsman-send-newsletter">Send Live</button>
					</th>
				</tr>
		</tbody>
	</table>
