...
class Newsman_Export_Request {
	...
	public function get_request_parameters() {
		...
		if ( ! empty( $api_key ) && empty( $parameters[ Newsman_Export_Retriever_Authenticator::API_KEY_PARAM ] ) ) {
			$parameters[ Newsman_Export_Retriever_Authenticator::API_KEY_PARAM ] = $api_key;
		}
	...
	protected function get_all_known_parameters() {
		...
		$hash_key = Newsman_Export_Retriever_Authenticator::API_KEY_PARAM;
		// phpcs:ignore WordPress.Security.NonceVerification.Recommended, WordPress.Security.NonceVerification.Missing
