 ...
 *
 * @class Newsman_Service_Sms_Subscribe
 */
class Newsman_Service_Sms_Subscribe extends Newsman_Service_Abstract_Service {
	/**
	 ...
	 *
	 * @param Newsman_Service_Context_Sms_Subscribe $context SMS subscribe context.
	 * @return array
