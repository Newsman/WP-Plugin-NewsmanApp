 ...
 *
 * @class Newsman_Service_Segment_AddSubscriber
 */
class Newsman_Service_Segment_AddSubscriber extends Newsman_Service_Abstract_Service {
	/**
	 ...
	 *
	 * @param Newsman_Service_Context_Segment_AddSubscriber $context Segment add subscriber context.
	 * @return array
