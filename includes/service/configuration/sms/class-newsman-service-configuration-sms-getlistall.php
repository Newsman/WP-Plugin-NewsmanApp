...
/**
 * API Client Service Configuration Get SMS List All
 *
 * @class Newsman_Service_Configuration_Sms_GetListAll
 */
class Newsman_Service_Configuration_Sms_GetListAll extends Newsman_Service_Abstract_Service {
	/**
